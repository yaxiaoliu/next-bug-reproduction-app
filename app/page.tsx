...
const DynamicComponent1 = dynamic(() => import('../components/hello1'), { ssr: false })
...
const DynamicComponent4 = dynamic(() => import('../components/hello4'), { ssr: false })

const DynamicComponent5 = dynamic(() => import('../components/hello5'), { ssr: false })
